...
/* WYMetalTableCornerView */

#import "WYMetalTableCornerView.h"
#import "WYMetalTableHeaderCell.h"

@implementation WYMetalTableCornerView
...
- (void)drawRect:(NSRect)rect {
	...
	[NSBezierPath fillRect:NSMakeRect(rect.origin.x, rect.origin.y, rect.size.width, 1)];
}
