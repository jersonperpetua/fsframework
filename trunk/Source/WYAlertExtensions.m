...
#import "WYAlertExtensions.h"

@interface WYAlertExtensions (PRIVATE)
+ (WYAlertExtensions *)sharedRunAlertWindow;
// do things
- (int)runModal;
...
@implementation WYAlertExtensions


static WYAlertExtensions *sharedRunAlertWindow;
+ (WYAlertExtensions *)sharedRunAlertWindow {
...
int WYRunAlertPanel(NSString *title, NSString *msg, NSString *defaultButton, NSString *otherButton) {
	return WYRunAlertPanelWithCheckboxAndDetails(title, msg, defaultButton, otherButton, nil, 0, nil, nil, 0);
}
int WYRunAlertPanelWithCheckbox(NSString *title, NSString *msg, NSString *defaultButton, NSString *otherButton, NSString *checkboxString, BOOL *checkboxState) {	
	return WYRunAlertPanelWithCheckboxAndDetails(title, msg, defaultButton, otherButton, checkboxString, checkboxState, nil, nil, 0);
}
int WYRunAlertPanelWithDetails(NSString *title, NSString *msg, NSString *defaultButton, NSString *otherButton, NSString *detailsString, NSString *detailsButtonTitle, BOOL *detailsState) {
	return WYRunAlertPanelWithCheckboxAndDetails(title, msg, defaultButton, otherButton, nil, 0, detailsString, detailsButtonTitle, detailsState);
}
int WYRunAlertPanelWithCheckboxAndDetails(NSString *title, NSString *msg, NSString *defaultButton, NSString *otherButton, NSString *checkboxString, BOOL *checkboxState, NSString *detailsString, NSString *detailsButtonTitle, BOOL *detailsState) {
	[[WYAlertExtensions sharedRunAlertWindow] setupWindowForTitle:title message:msg defaultButton:defaultButton otherButton:otherButton checkboxString:checkboxString checkboxState:checkboxState detailsString:detailsString detailsButtonTitle:detailsButtonTitle detialsState:detailsState];
	return [[WYAlertExtensions sharedRunAlertWindow] runModal];
}

#pragma mark running different sheets
void WYBeginAlertSheet(NSString *title, NSString *defaultButton, NSString *otherButton, NSWindow *docWindow, id modalDelegate, SEL didEndSelector, SEL didDismissSelector, void *contextInfo, NSString *msg) {
	WYBeginAlertSheetWithCheckboxAndDetails(title, defaultButton, otherButton, docWindow, modalDelegate, didEndSelector, didDismissSelector, contextInfo, msg, nil, -1, nil, nil, -1);
}
void WYBeginAlertSheetWithCheckbox(NSString *title, NSString *defaultButton, NSString *otherButton, NSWindow *docWindow, id modalDelegate, SEL didEndSelector, SEL didDismissSelector, void *contextInfo, NSString *msg, NSString *checkboxString, BOOL checkboxState) {
	WYBeginAlertSheetWithCheckboxAndDetails(title, defaultButton, otherButton, docWindow, modalDelegate, didEndSelector, didDismissSelector, contextInfo, msg, checkboxString, checkboxState, nil, nil, -1);
}
void WYBeginAlertSheetWithDetails(NSString *title, NSString *defaultButton, NSString *otherButton, NSWindow *docWindow, id modalDelegate, SEL didEndSelector, SEL didDismissSelector, void *contextInfo, NSString *msg, NSString *detailsString, NSString *detailsButtonTitle, BOOL detailsState) {
	WYBeginAlertSheetWithCheckboxAndDetails(title, defaultButton, otherButton, docWindow, modalDelegate, didEndSelector, didDismissSelector, contextInfo, msg, nil, -1, detailsString, detailsButtonTitle, detailsState);
}
void WYBeginAlertSheetWithCheckboxAndDetails(NSString *title, NSString *defaultButton, NSString *otherButton, NSWindow *docWindow, id modalDelegate, SEL didEndSelector, SEL didDismissSelector, void *contextInfo, NSString *msg, NSString *checkboxString, BOOL checkboxState, NSString *detailsString, NSString *detailsButtonTitle, BOOL detailsState) {
	id run_object = [[WYAlertExtensions alloc] init];
