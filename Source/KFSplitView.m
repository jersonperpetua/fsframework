...
- (void)mouseDown:(NSEvent *)theEvent asIfOnDivider:(int)divider
{
    ...
    // WY - tripple clicking, quad clicking, etc shouldn't be allowed
...
- (BOOL)setPositionAutosaveName:(NSString *)name
{
    ...
    // WY - This does not remove all of the observers that have been added.  If setPositionAutosaveName
...
- (void)kfSavePositionUsingAutosaveName:(id)sender
{
    // WY - using only one autosaveName here makes having a set of all
